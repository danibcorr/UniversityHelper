...
def modify_metadata_and_add_cover(pdf_path: str, degree_name: str, output_path: str) -> None:
...
def analyze_directory(original_directory: str, new_directory: str, degree_name: str) -> None:
...
def main() -> None:
    ...
    degree = st.selectbox("Possible grades",
